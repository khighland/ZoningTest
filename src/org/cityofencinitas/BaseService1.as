...
package org.cityofencinitas
{
	 ...
	 */ 
	public class BaseService1 extends AbstractWebService
    {
		private var results:Object;
		private var schemaMgr:SchemaManager;
		private var BaseService1Service:WSDLService;
		private var BaseService1PortType:WSDLPortType;
		private var BaseService1Binding:WSDLBinding;
		private var BaseService1Port:WSDLPort;
		private var currentOperation:WSDLOperation;
		private var internal_schema:BaseService1Schema;
		 ...
		 */
		public function BaseService1(destination:String=null, rootURL:String=null)
		{
			...
			internal_schema = new BaseService1Schema();
...
BaseService1Service = new WSDLService("BaseService1Service");
			BaseService1Port = new WSDLPort("BaseService1Port",BaseService1Service);
        	BaseService1Binding = new WSDLBinding("BaseService1Binding");
	        BaseService1PortType = new WSDLPortType("BaseService1PortType");
       		BaseService1Binding.portType = BaseService1PortType;
       		BaseService1Port.binding = BaseService1Binding;
       		BaseService1Service.addPort(BaseService1Port);
       		BaseService1Port.endpointURI = "http://encuploadservice.cityofencinitas.org/EncUploadService/service1.asmx";
       		if(this.endpointURI == null)
       		{
       			this.endpointURI = BaseService1Port.endpointURI; 
       		} 
       		
			var requestMessage:WSDLMessage;
			var responseMessage:WSDLMessage;
			//define the WSDLOperation: new WSDLOperation(methodName)
            var processRequest:WSDLOperation = new WSDLOperation("ProcessRequest");
				//input message for the operation
    	        requestMessage = new WSDLMessage("ProcessRequest");
            				requestMessage.addPart(new WSDLMessagePart(new QName("http://tempuri.org/","f"),null,new QName("http://www.w3.org/2001/XMLSchema","base64Binary")));
            				requestMessage.addPart(new WSDLMessagePart(new QName("http://tempuri.org/","filename"),null,new QName("http://www.w3.org/2001/XMLSchema","string")));
			...
			requestMessage.encoding.useStyle="literal";
	            ...
	            requestMessage.wrappedQName = new QName("http://tempuri.org/","ProcessRequest");
                
                responseMessage = new WSDLMessage("ProcessRequestResponse");
            				responseMessage.addPart(new WSDLMessagePart(new QName("http://tempuri.org/","ProcessRequestResult"),null,new QName("http://www.w3.org/2001/XMLSchema","string")));
	            ...
	            responseMessage.wrappedQName = new QName("http://tempuri.org/","ProcessRequestResponse");
			processRequest.inputMessage = requestMessage;
	        processRequest.outputMessage = responseMessage;
            processRequest.schemaManager = this.schemaMgr;
            processRequest.soapAction = "http://tempuri.org/ProcessRequest";
            processRequest.style = "document";
            BaseService1Service.getPort("BaseService1Port").binding.portType.addOperation(processRequest);
		}
		/**
		...
		public function processRequest(f:flash.utils.ByteArray,filename:String):AsyncToken
		{
            ...
            out["f"] = f;
	            ...
	            currentOperation = BaseService1Service.getPort("BaseService1Port").binding.portType.getOperation("ProcessRequest");
